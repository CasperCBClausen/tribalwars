...
(function () {
  ...
  const membersHandler  = makeCollapseHandler(membersContent,  membersCollapseBtn);
  const overviewHandler = makeCollapseHandler(overviewContent, overviewCollapseBtn);
  const resultsHandler  = makeCollapseHandler(resultsContent,  resultsCollapseBtn);
  membersCollapseBtn.onclick  = membersHandler;  membersSectionTitle.onclick  = membersHandler;
  overviewCollapseBtn.onclick = overviewHandler; overviewSectionTitle.onclick = overviewHandler;
  resultsCollapseBtn.onclick  = resultsHandler;  resultsSectionTitle.onclick  = resultsHandler;
