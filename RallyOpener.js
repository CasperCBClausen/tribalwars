...
var amWarning = el('div',{style:'position:absolute;left:calc(50% + 90px);top:50%;transform:translateY(-50%);font-size:11px;color:#ffaa00;white-space:nowrap;'});
amWarning.innerHTML = '⚠ No Account Manager - some functionality disabled';
